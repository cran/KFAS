subroutine obssim(ymiss,timevar, yt, zt, tt, rtv, qt, a1, p1, &
p1inf, nnd, nsim2, etaplus, aplus1, &
p, n, m, r, info,tolf,rankp,c,ysim,tol,nd,ndl)
    !Subroutine for simulating observation vectors of general state space model
    !Called by R function simObs
    ...
    double precision, intent(inout), dimension(n,p,4*nsim2) :: ysim
    ...
    double precision, dimension(m,n) :: ahat,aplushat,asim1,asim2,asim3,asim4
    ...
    do i = 1, nsim2
        ...
        do t = 1, n
            if(sum(ymiss(t,1:p)).GT.0) then
                asim1(1:m,t) = ahat(1:m,t) - aplushat(1:m,t) + aplus(1:m,t)
                asim2(1:m,t) = ahat(1:m,t) + aplushat(1:m,t) - aplus(1:m,t)
                asim3(1:m,t) = ahat(1:m,t)+ c(i)*(asim1(1:m,t)-ahat(1:m,t))
                asim4(1:m,t) = ahat(1:m,t)+ c(i)*(asim2(1:m,t)-ahat(1:m,t))

                call dgemv('n',p,m,1.0d0,zt(1:p,1:m,(t-1)*timevar(1)+1),p,asim1(1:m,t),1,0.0d0,ysim(t,1:p,i),1)
                call dgemv('n',p,m,1.0d0,zt(1:p,1:m,(t-1)*timevar(1)+1),p,asim2(1:m,t),1,0.0d0,ysim(t,1:p,i+nsim2),1)
                call dgemv('n',p,m,1.0d0,zt(1:p,1:m,(t-1)*timevar(1)+1),p,asim3(1:m,t),1,0.0d0,ysim(t,1:p,i+2*nsim2),1)
                call dgemv('n',p,m,1.0d0,zt(1:p,1:m,(t-1)*timevar(1)+1),p,asim4(1:m,t),1,0.0d0,ysim(t,1:p,i+3*nsim2),1)
            end if
        end do
