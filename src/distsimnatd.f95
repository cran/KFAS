subroutine distsimnatd(ymiss,timevar, yt, zt, ht, tt, rtv, qt, a1, p1, &
p1inf, nnd,  nsim2, epsplus, etaplus, aplus1, &
p, n, m, r, info, tolf,rankp,epssim,etasim,tol,nd,ndl)
    ...
    double precision, intent(inout), dimension(p,n,nsim2) :: epssim
    double precision, intent(inout), dimension(r,n,nsim2) :: etasim
    double precision, dimension(n,p) :: yplus
    double precision, dimension(m,n+1) :: at,aplus
    double precision, dimension(p,n) :: vt,ft,finf,epsplushat,epshat
