subroutine distsima(ymiss,timevar, yt, zt, tt, rtv, qt, a1, p1, &
p1inf, nnd, nsim2, etaplus, aplus1,  p, n, m, r, info,tolf,rankp,c,etasim,tol,nd,ndl)
